...
function HomePage() {
  ...
  const productsVisit = (e) => {
    if (window.gtag) {
      window.gtag('event', 'products_page_visit', {
        value: 1
      });
    }
  };
  ...
  const galleryItems = [
    ...
    },
    {
      ...
      image: '/Hueline-Enterprises-Lead-Management-System/assets/images/shop gallery/img2.webp',
      category: 'Commercial'
    },
    {
      title: 'Joy of Picking Paint',
      image: '/Hueline-Enterprises-Lead-Management-System/assets/images/shop gallery/img3.webp',
      category: 'Experience'
    },
    {
      title: 'Consultation Services',
      image: '/Hueline-Enterprises-Lead-Management-System/assets/images/shop gallery/img4.webp',
      category: 'Services'
    },
    {
      title: 'Paint Gallery Display',
      image: '/Hueline-Enterprises-Lead-Management-System/assets/images/shop gallery/img5.webp',
      category: 'Showroom'
    },
    {
      title: 'Paint Collection',
      image: '/Hueline-Enterprises-Lead-Management-System/assets/images/shop gallery/img6.webp',
      category: 'Products'
    },
    {
      title: 'Enterprise Gallery',
      image: '/Hueline-Enterprises-Lead-Management-System/assets/images/shop gallery/img7.webp',
      category: 'Store'
    }
  ]
  ...
  return (
    <>
      ...
      <div className='section' id='products'>
        ...
        <p onClick={productsVisit}><Link to="/ProductsPage">View products <MoveRight className='MoveRight' /></Link></p>
        <Swiper
